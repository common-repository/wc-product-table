						...
						<div class="tab-content">
							<div id="tabs">
								...
								<div id="tabs-1">
									...
									<p><?php _e('Use the shortcode <kbd>[wc-product-table]</kbd> for displaying the Amazing Product Table with all of your products together. User can order products here easily without visiting individual product.', 'wc-product-table')?></p>
											...
											<tr>
												...
												<td>
													<fieldset>
														...
														<br>
														<label>
															<input name="wptcd-table-design-type" type="radio" value="custom" id="wptcd-table-design-type" class="only-pro-radio wptcd-table-design-type"<?php echo ($tbl_design_type=='custom')?' checked':''?> disabled> <?php _e('Custom', 'wc-product-table')?>
														</label>
													</fieldset>
												</td>
											</tr>
											...
											<tr>
												...
												<td>
													<label for="wptcd-quick-view">
														<input name="show_quick_view" type="checkbox" class="only-pro-checkbox" id="wptcd-quick-view" <?php echo esc_attr($show_quick_view=='checked'?'checked':'')?> disabled>
											...
											<tr>
												...
												<td>
													<label for="wptcd-show-review-column">
														<input name="show_review_column" type="checkbox" class="only-pro-checkbox" id="wptcd-show-review-column" <?php echo esc_attr($show_review_column=='checked'?'checked':'')?> disabled>
														<?php _e('Show the Review Column', 'wc-product-table')?>
													</label>
												</td>
											</tr>
										...
										<tbody>
											<tr>
												...
												<td>
													...
													<span class="only-pro-textbox"></span>
											...
											<tr>
												...
												<td>
													<label for="wptcd-show-search-box">
														<input name="show_search_box" type="checkbox" class="only-pro-checkbox" id="wptcd-show-search-box" <?php echo esc_attr($show_search_box=='checked'?'checked':'')?> disabled>
														<?php _e('Show the Search Box.', 'wc-product-table')?>
													</label>
												</td>
											</tr>
											<tr>
												...
												<td>
													<label for="wptcd-show-reset-btn">
														<input name="show_reset_btn" class="only-pro-checkbox" type="checkbox" id="wptcd-show-reset-btn" <?php echo esc_attr($show_reset_btn=='checked'?'checked':'')?> disabled>
														<?php _e('Show the Reset Button.', 'wc-product-table')?>
													</label>
												</td>
											</tr>
											<tr>
												...
												<td>
													<label for="wptcd-show-mini-cart">
														<input name="show_mini_cart" class="only-pro-checkbox" type="checkbox" id="wptcd-show-mini-cart" <?php echo esc_attr($show_mini_cart=='checked'?'checked':'')?> disabled>
														<?php _e('Show the Mini Cart.', 'wc-product-table')?>
													</label>
												</td>
											</tr>
