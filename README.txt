...
Contributors: hasanfardous, woobuddies
Donate link: https://woobuddies.com
Tags: woobuddies, woo-product-table, product-table-woocommerce, woocommerce, woocommerce-product-table, woocommerce-products
...
1. Adding the shortcode to a new page for displaying the Product Table for WooCommerce.
2. Product table Design options inside the admin area.
3. Product table Content options inside the admin area.
4. Product table controls options inside the admin area.
